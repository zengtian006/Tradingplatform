 ...
 */
public class AccountSettingActivity_bacup extends AppCompatActivity {
    private static final int CAPTURE_IMAGE_REQUEST_CODE_ID = 100;
    private static final int CAPTURE_IMAGE_REQUEST_CODE_BIZ = 200;
    private static final String TAG = AccountSettingActivity_bacup.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accountsetting_backup);

        pDialog = new ProgressDialog(AccountSettingActivity_bacup.this);
...
//                    response = response.substring(response.indexOf("{"), response.lastIndexOf("}") + 1);
                    ...
                    if (success) {
                        ...
                        Toast.makeText(AccountSettingActivity_bacup.this, "Your profile has been updated successfully!", Toast.LENGTH_LONG).show();

                        // Launch Login activity
                        Intent intent = new Intent(
                                AccountSettingActivity_bacup.this, MainActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(AccountSettingActivity_bacup.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            scrollView.post(new Runnable() {
                @Override
                public void run() {
                    AccountSettingActivity_bacup.scrollView.fullScroll(ScrollView.FOCUS_DOWN);
                }
            });
        }
    }
