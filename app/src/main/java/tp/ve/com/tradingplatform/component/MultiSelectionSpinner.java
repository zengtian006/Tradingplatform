package tp.ve.com.tradingplatform.component;
...
public class MultiSelectionSpinner extends Spinner implements
    ...
    public static ArrayList<String> checkItemPostion;
    ...
    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
        if (mSelection != null && which < mSelection.length) {
            ...
            if (isChecked) {
                Log.v("test", "ChechedPositon:" + which);

                checkItemPostion.add(String.valueOf(which));
            } else {
                Log.v("test", "unChechedPositon:" + which);
                checkItemPostion.remove(String.valueOf(which));
            }
        } else {
...
//                    });
    ...
    public void setItems(String[] items) {
        checkItemPostion = new ArrayList<String>();
        _items = items;
    ...
    public void setSelection(int[] selectedIndices) {
        ...
        for (int index : selectedIndices) {
            if (index >= 0 && index < mSelection.length) {
                checkItemPostion.add(String.valueOf(index));
                mSelection[index] = true;
                mSelectionAtStart[index] = true;
            } else {
                throw new IllegalArgumentException("Index " + index
